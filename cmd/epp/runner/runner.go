...
func hasPluginType(config *configapiv1.EndpointPickerConfig, pluginType string) bool {
	if config == nil {
		return false
	}
...
func validateDataParallelConfiguration(config *configapiv1.EndpointPickerConfig, fallbackSize int) error {
