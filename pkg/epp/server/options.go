...
type Options struct {
	...
	EndpointDataParallelSize    int             // Logical ranks per pod behind one shared target port.
...
func (opts *Options) AddFlags(fs *pflag.FlagSet) {
	...
	fs.IntVar(&opts.EndpointDataParallelSize, "endpoint-data-parallel-size", opts.EndpointDataParallelSize,
		"Number of logical data-parallel rank endpoints per pod behind one shared target port.")
